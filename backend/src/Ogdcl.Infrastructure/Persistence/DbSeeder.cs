...
public static class DbSeeder
{
    public static async Task SeedAsync(AppDbContext db, IPasswordHasher hasher)
    {
        ...
        db.AssignmentRules.AddRange(
            ...
            new AssignmentRule { Category = catCivil, Department = civil, DefaultPriority = TicketPriority.High });
        ...
        db.Users.AddRange(
            MakeUser("admin", "Admin@123", "System Administrator", UserRole.Admin, null),
